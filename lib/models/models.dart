...
Map<String, dynamic> coordToJson(LatLng c) => {'lat': c.latitude, 'lng': c.longitude};
...
class Place {
  ...
  factory Place.fromJson(Map<String, dynamic> json) => Place(
        ...
        category: _enumFrom(PlaceCategory.values, json['category'], PlaceCategory.area),
      );
}
...
class Vehicle {
  ...
  factory Vehicle.fromJson(Map<String, dynamic> json) => Vehicle(
        ...
        vehicleClass: _enumFrom(VehicleClass.values, json['vehicleClass'], VehicleClass.economy),
...
class DriverDocument {
  ...
  factory DriverDocument.fromJson(Map<String, dynamic> json) => DriverDocument(
        ...
        status: _enumFrom(DocumentStatus.values, json['status'], DocumentStatus.missing),
...
class Ride {
  ...
  factory Ride.fromJson(Map<String, dynamic> json) {
    ...
    return Ride(
      ...
      stop: json['stop'] == null ? null : Place.fromJson(json['stop'] as Map<String, dynamic>),
      askingPrice: json['askingPrice'] as int,
      finalPrice: json['finalPrice'] as int?,
      recommendedPrice: json['recommendedPrice'] as int,
      distanceKm: (json['distanceKm'] as num).toDouble(),
      durationMinutes: json['durationMinutes'] as int,
      paymentMethod: _enumFrom(PaymentMethod.values, json['paymentMethod'], PaymentMethod.cash),
      passengerCount: json['passengerCount'] as int? ?? 1,
      comment: json['comment'] as String?,
      options: (json['options'] as List<dynamic>? ?? [])
          .map((o) => _enumFrom(RideOption.values, o, RideOption.luggage))
          .toList(),
      status: _enumFrom(RideStatus.values, json['status'], RideStatus.searching),
      ...
      cancelledBy: json['cancelledBy'] == null
          ? null
          : _enumFrom(CancelledBy.values, json['cancelledBy'], CancelledBy.system),
      ...
      ratingByPassenger: json['ratingByPassenger'] == null
          ? null
          : RideRating.fromJson(json['ratingByPassenger'] as Map<String, dynamic>),
...
class AppNotification {
  ...
  factory AppNotification.fromJson(Map<String, dynamic> json) => AppNotification(
        ...
        createdAt: DateTime.fromMillisecondsSinceEpoch(json['createdAt'] as int),
        read: json['read'] as bool? ?? false,
        kind: _enumFrom(NotificationKind.values, json['kind'], NotificationKind.system),
        rideId: json['rideId'] as String?,
      );
}
...
class Txn {
  ...
  factory Txn.fromJson(Map<String, dynamic> json) => Txn(
        id: json['id'] as String,
        kind: _enumFrom(TransactionKind.values, json['kind'], TransactionKind.ridePayment),
